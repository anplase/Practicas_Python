frase = input("Introduzca una frase (con minus, Mayus, Num, acentos, y espacios): ")
...
def conta_palabras(frase):
	Npalabras = frase.count(' ')
	if Npalabras>0:
		print ('La frase contine {} palabras' .format(Npalabras+1))
	else:
		print ('La frase contiene solo una palabra')
conta_palabras(frase)

print(' lo que me da num_palabras1 es: {}'.format(num_palabras1(frase)))

print ('lo que me da el num_palabras2 es : {}' .format(num_palabras2(frase)))